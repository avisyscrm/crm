...
@Component({
  ...
  styleUrls: ['./number-scheme-form.component.scss']
})
export class NumberSchemeFormComponent implements OnInit {
  numberScheme = new FormGroup({
    ...
    'subType': new FormControl('', [Validators.required,Validators.maxLength(15),Validators.minLength(15)]),
    'released': new FormControl('',[Validators.required]),
    'format': new FormControl('',[Validators.required,Validators.maxLength(30),Validators.minLength(30)]),
